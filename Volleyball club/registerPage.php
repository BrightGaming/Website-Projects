...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $Email_check_query = "SELECT * FROM vbdb WHERE Email='$Email' LIMIT 1";
    $result = mysqli_query($connection, $Email_check_query);
    if (mysqli_num_rows($result) > 0) {
        $message = "Email is registered by another user!";
    } else {
        $sql = "INSERT INTO vbdb (Name, Age, Email, Address, Phone, DOB, Password) 
        VALUES ('$Name', '$Age', '$Email', '$Address', '$Phone', '$DOB', '$Password')";
